...
class SubtaskInfo(JobInfo):
    ...
    def get_future_destination(self):
        return self._future_destination_layer_node
        
    def get_subtask_id(self):
        return self._delimeter.join([self.get_job_id(), self._source_layer_node.to_string(), self._destination_layer_node.to_string()])
