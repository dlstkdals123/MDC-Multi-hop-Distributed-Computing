...
class ModelConfig:
    ...
    def __init__(self, model_config: Dict[str, any]):
        ...
        self._warmup = self._model_config["warmup"]
        self._warmup_input = self._model_config["warmup_input"]
        self._computing_ratios = self._model_config["computing_ratios"]
        self._transfer_ratios = self._model_config["transfer_ratios"]
